...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        true
            ...
            <li class="visible-xs"><a href=""><i class="fa fa-home"></i> My Account</a></li>
            <li class="visible-xs"><a href=""><i class="fa fa-sign-out"></i> Logout</a></li>
        @else
            <li class="visible-xs"><a href=""> <i class="fa fa-lock"></i> Login</a></li>
            <li class="visible-xs"><a href=""> <i class="fa fa-sign-in"></i> Register</a></li>
        @endif
        ...
        <li>
            <!-- search form -->
            <form action="" method="GET" class="form-inline" style="margin: 15px 0 0;">
