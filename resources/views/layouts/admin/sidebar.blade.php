        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview @if(request()->segment(2) == 'products' || request()->segment(2) == 'attributes' || request()->segment(2) == 'brands') active @endif">
                ...
                <ul class="treeview-menu">
                    @if(
                        true
                        // $user->hasPermission('view-product')
                        )<li><a href="
                        {{-- {{ route('admin.products.index') }} --}}
                        "><i class="fa fa-circle-o"></i> List products</a></li>@endif
                    @if(
                        true
                    // $user->hasPermission('create-product')
                    )<li><a href="
                        {{-- {{ route('admin.products.create') }} --}}
                        "><i class="fa fa-plus"></i> Create product</a></li>@endif
                    ...
                    <ul class="treeview-menu">
                        <li><a href="
                            ...
                            "><i class="fa fa-circle-o"></i> List attributes</a></li>
                        <li><a href="
                            {{-- {{ route('admin.attributes.create') }} --}}
                            "><i class="fa fa-plus"></i> Create attribute</a></li>
                    </ul>
                    </li>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="
                            ...
                            "><i class="fa fa-circle-o"></i> List brands</a></li>
                        <li><a href="
                            {{-- {{ route('admin.brands.create') }} --}}
                            "><i class="fa fa-plus"></i> Create brand</a></li>
                    </ul>
                    </li>
                </ul>
            </li>
            <li class="treeview @if(request()->segment(2) == 'categories') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="
                        ...
                        "><i class="fa fa-circle-o"></i> List categories</a></li>
                    <li><a href="
                        {{-- {{ route('admin.categories.create') }} --}}
                        "><i class="fa fa-plus"></i> Create category</a></li>
                </ul>
            </li>
            <li class="treeview @if(request()->segment(2) == 'customers' || request()->segment(2) == 'addresses') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="
                        ...
                        "><i class="fa fa-circle-o"></i> List customers</a></li>
                    <li><a href="
                        {{-- {{ route('admin.customers.create') }} --}}
                        "><i class="fa fa-plus"></i> Create customer</a></li>
                    <li class="@if(request()->segment(2) == 'addresses') active @endif">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="
                                ...
                                "><i class="fa fa-circle-o"></i> List addresses</a></li>
                            <li><a href="
                                {{-- {{ route('admin.addresses.create') }} --}}
                                "><i class="fa fa-plus"></i> Create address</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview @if(request()->segment(2) == 'orders') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="
                        ...
                        "><i class="fa fa-circle-o"></i> List orders</a></li>
                </ul>
            </li>
            <li class="treeview @if(request()->segment(2) == 'order-statuses') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="
                        ...
                        "><i class="fa fa-circle-o"></i> List order statuses</a></li>
                    <li><a href="
                        {{-- {{ route('admin.order-statuses.create') }} --}}
                        "><i class="fa fa-plus"></i> Create order status</a></li>
                </ul>
            </li>
            ...
            <li class="treeview @if(request()->segment(2) == 'couriers') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="
                        ...
                        "><i class="fa fa-circle-o"></i> List couriers</a></li>
                    <li><a href="
                        {{-- {{ route('admin.couriers.create') }} --}}
                        "><i class="fa fa-plus"></i> Create courier</a></li>
                </ul>
            </li>
            ...
            <ul class="treeview-menu">
                <li><a href="
                    ...
                    "><i class="fa fa-circle-o"></i> List employees</a></li>
                <li><a href="
                    {{-- {{ route('admin.employees.create') }} --}}
                    "><i class="fa fa-plus"></i> Create employee</a></li>
                <li class="@if(request()->segment(2) == 'roles') active @endif">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="
                            ...
                            "><i class="fa fa-circle-o"></i> List roles</a></li>
                    </ul>
                </li>
                <li class="@if(request()->segment(2) == 'permissions') active @endif">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="
                            ...
                            "><i class="fa fa-circle-o"></i> List permissions</a></li>
                    </ul>
                </li>
            </ul>
        </li>
            ...
            <li class="treeview @if(request()->segment(2) == 'countries' || request()->segment(2) == 'provinces') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="
                        ...
                        "><i class="fa fa-circle-o"></i> List</a></li>
                </ul>
            </li>
        </ul>
    </section>
